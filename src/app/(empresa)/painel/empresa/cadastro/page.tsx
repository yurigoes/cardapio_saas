          ...
          {TIPOS_DOC.map(t => {
            ...
            return (
              <div key={t.id} className={`rounded-xl border p-3 ${
                enviado?.validado ? "border-emerald-500/30 bg-emerald-500/5" :
