...
const SPECS: Spec[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    ...
    itens: [
      ...
      { chave: "Forma 'cartao_caixa'", valor: "Quando totem tela grande não consegue integrar com a maquininha (caso típico Stone Smart), totem mostra tela 'Vá ao caixa' com número de pedido GIGANTE + total destacado. Atendente processa cartão manual e fecha o pedido em /painel/pedidos. Pedido fica com forma_pagamento='cartao_caixa' e dispara impressão normal." },
